...
namespace Pullenti.Semantic
{
    ...
    public class SemFragment : ISemContainer
    {
        ...
        /// <summary>
        /// Это список альтернативных фрагментов, построенных из текста
        /// </summary>
        public List<SemFragment> AltFragments = new List<SemFragment>();
        /// <summary>
        /// Это некий коэффициент, при анализе вариантов основным считается вариант с наибольшим 
        /// коэффициентом, остальные помещаются в AltFragments (если есть)
        /// </summary>
        public double Rank;
        /// <summary>
