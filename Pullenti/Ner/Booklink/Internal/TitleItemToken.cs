...
namespace Pullenti.Ner.Booklink.Internal
{
    class TitleItemToken : Pullenti.Ner.MetaToken
    {
        ...
        public static void Initialize()
        {
            ...
            foreach (string s in new string[] {"РАБОТА", "ДИССЕРТАЦИЯ", "ОТЧЕТ", "ПЛАН", "ОБЗОР", "ДИПЛОМ", "ПРОЕКТ", "СПРАВКА", "АВТОРЕФЕРАТ", "РЕФЕРАТ", "TECHNOLOGY ISSUES", "TECHNOLOGY COURSE", "УЧЕБНИК", "УЧЕБНОЕ ПОСОБИЕ"}) 
            {
