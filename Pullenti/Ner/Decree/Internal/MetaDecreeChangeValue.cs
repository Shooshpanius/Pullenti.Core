...
namespace Pullenti.Ner.Decree.Internal
{
    class MetaDecreeChangeValue : Pullenti.Ner.Metadata.ReferentClass
    {
        public static void Initialize()
        {
            ...
            fi.AddValue(Pullenti.Ner.Decree.DecreeChangeValueKind.Definition.ToString(), "Определение", null, null);
            ...
            fi.AddValue(Pullenti.Ner.Decree.DecreeChangeValueKind.ExtAppendix.ToString(), "Внешнее приложение", null, null);
            KindFeature = fi;
            ...
            GlobalMeta.AddFeature(Pullenti.Ner.Decree.DecreeChangeValueReferent.ATTR_BEGINCHAR, "Начальная позиция текста", 0, 0);
            GlobalMeta.AddFeature(Pullenti.Ner.Decree.DecreeChangeValueReferent.ATTR_ENDCHAR, "Конечная позиция текста", 0, 0);
        }
