    ...
    public class TransportAnalyzer : Pullenti.Ner.Analyzer
    {
        ...
        public override Dictionary<string, byte[]> Images
        {
            get
            {
                ...
                res.Add(TransportKind.Fly.ToString(), Pullenti.Ner.Core.Internal.ResourceHelper3.GetBytes("fly.png"));
                res.Add(TransportKind.Ship.ToString(), Pullenti.Ner.Core.Internal.ResourceHelper3.GetBytes("ship.png"));
                res.Add(TransportKind.Space.ToString(), Pullenti.Ner.Core.Internal.ResourceHelper3.GetBytes("space.png"));
                res.Add(TransportKind.Train.ToString(), Pullenti.Ner.Core.Internal.ResourceHelper3.GetBytes("train.png"));
                res.Add(TransportKind.Auto.ToString(), Pullenti.Ner.Core.Internal.ResourceHelper3.GetBytes("auto.png"));
                res.Add(Pullenti.Ner.Transport.Internal.MetaTransport.ImageId, Pullenti.Ner.Core.Internal.ResourceHelper3.GetBytes("transport.png"));
                return res;
            }
        }
