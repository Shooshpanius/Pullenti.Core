...
namespace Pullenti.Ner.Instrument.Internal
{
    internal class MetaInstrumentBlock : Pullenti.Ner.Metadata.ReferentClass
    {
        public static void Initialize()
        {
            ...
            GlobalMeta.KindFeature.AddValue(Pullenti.Ner.Instrument.InstrumentKind.Footnote.ToString(), "Сноска", null, null);
            ...
            GlobalMeta.KindFeature.AddValue(Pullenti.Ner.Instrument.InstrumentKind.Form.ToString(), "Форма", null, null);
            ...
            GlobalMeta.AddFeature(Pullenti.Ner.Instrument.InstrumentBlockReferent.ATTR_TAILNUMBER, "Номер в конце строки", 0, 1);
            ...
            GlobalMeta.AddFeature(Pullenti.Ner.Instrument.InstrumentBlockReferent.ATTR_ERROR, "Ошибка", 0, 1);
            GlobalMeta.AddFeature(Pullenti.Ner.Instrument.InstrumentBlockReferent.ATTR_TABLECOLUMNS, "Число столбцов таблицы", 0, 1);
        }
