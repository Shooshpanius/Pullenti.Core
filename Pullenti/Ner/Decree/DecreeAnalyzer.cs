    ...
    public class DecreeAnalyzer : Pullenti.Ner.Analyzer
    {
        ...
        static List<Pullenti.Ner.ReferentToken> _TryAttach(List<Pullenti.Ner.Decree.Internal.DecreeToken> dts, Pullenti.Ner.Decree.Internal.DecreeToken baseTyp, bool afterDecree, Pullenti.Ner.Core.AnalyzerData ad)
        {
            ...
            for (i = 0; i < dts.Count; i++) 
            {
                ...
                else if (dts[i].Typ == Pullenti.Ner.Decree.Internal.DecreeToken.ItemType.Name) 
                {
                    ...
                    if (dts[i].FullValue != null) 
                        dec.AddNameStr(dts[i].FullValue, dts[i]);
                    dec.AddNameStr(nam, new Pullenti.Ner.MetaToken(tt0, tt1));
                }
        ...
        void _processPartsAndChanges(Pullenti.Ner.Core.AnalysisKit kit, Pullenti.Ner.Decree.Internal.DecreeToken baseTyp)
        {
            ...
            for (Pullenti.Ner.Token t = kit.FirstToken; t != null; t = t.Next) 
            {
                ...
                if ((!ok1 && t.Previous != null && t.Previous.IsTableControlChar) && t.Previous.IsNewlineBefore) 
                    ok1 = true;
                if (ok1) 
                {
                    if (t.IsValue("ИЗМЕНЕНИЯ", null)) 
                    {
                    }
                    ...
                    dcht = Pullenti.Ner.Decree.Internal.DecreeChangeToken.TryAttach(t, (rootChange == null ? null : rootChange.Referent as DecreeChangeReferent), false, changeStack, false, false, null);
                ...
                if (dcht != null && ((dcht.IsStart || dcht.ChangeVal != null)) && !dcht.Ignorable) 
                {
                    ...
                    {
                        Pullenti.Ner.Decree.Internal.DecreeChangeToken dcht1 = Pullenti.Ner.Decree.Internal.DecreeChangeToken.TryAttach(dcht.EndToken.Next, (rootChange == null ? null : rootChange.Referent as DecreeChangeReferent), false, changeStack, false, false, null);
                    ...
                    else if (dcht.Typ == Pullenti.Ner.Decree.Internal.DecreeChangeTokenTyp.StartSingle && dcht.Decree != null && expireRegime == 0) 
                    {
                        ...
                        if (!ok) 
                        {
                            ...
                            {
                                Pullenti.Ner.Decree.Internal.DecreeChangeToken next = Pullenti.Ner.Decree.Internal.DecreeChangeToken.TryAttach(tt2, null, true, null, false, false, null);
                                if (next != null) 
                                {
                    ...
                    if ((dcht == null && t.IsNewlineBefore && !t.IsCharOf("[")) && !t.IsTableControlChar) 
                    {
                        ...
                        if (expireRegime > 0) 
                        {
                            ...
                            for (int kk = 0; kk < 3; kk++) 
                            {
                                ...
                                {
                                    Pullenti.Ner.Decree.Internal.DecreeChangeToken ddd = Pullenti.Ner.Decree.Internal.DecreeChangeToken.TryAttach(tt3, null, false, null, false, false, null);
                                    if (ddd != null) 
                                    {
                ...
                if (rts != null) 
                {
                    foreach (Pullenti.Ner.MetaToken kp in rts) 
                    {
                        ...
                        for (int i = 0; i < dprList.Count; i++) 
                        {
                            ...
                            if (dr.TableRow != null || dr.TableItem != null) 
                            {
                                if (dr.Table == null) 
                                {
                                    if (rootChange != null) 
                            ...
                            kit.EmbedToken(rt);
                            t = rt;
                            if (dprs.Count > 1 && t.Previous != null && t.Previous.IsHiphen) 
                            {
                                if (diaps == null) 
                ...
                if (dcht != null && ((hasStartChange > 0 || expireRegime > 0)) && !dcht.Ignorable) 
                {
                    ...
                    if (dcht.Typ == Pullenti.Ner.Decree.Internal.DecreeChangeTokenTyp.StartMultu && ((rootChangeQues == null || rootChangeQues.Decree != dcht.Decree))) 
                    {
                        ...
                        if (((changeStack.Count > 0 || dcht.Decree != null)) && expireRegime == 0) 
                        {
                            ...
                            if (dcht.AppExtChanges != null) 
                                rch.AddSlot("APP_CHANGES", (dcht.AppExtChanges.Values.Count > 0 ? dcht.AppExtChanges.Values[0].ToString() : ""), true, 0);
                            ...
                            for (Pullenti.Ner.Token tt0 = dcht.BeginToken.Previous; tt0 != null; tt0 = tt0.Previous) 
                            {
                                ...
                                {
                                    Pullenti.Ner.Decree.Internal.DecreeChangeToken dcht0 = Pullenti.Ner.Decree.Internal.DecreeChangeToken.TryAttach(tt0, null, false, null, false, false, null);
                        ...
                        if (expireRegime == 0) 
                        {
                            if (t.IsNewlineAfter) 
                                continue;
                            Pullenti.Ner.Decree.Internal.DecreeChangeToken tt2 = Pullenti.Ner.Decree.Internal.DecreeChangeToken.TryAttach(t.Next, null, false, null, false, false, null);
                    ...
                    for (Pullenti.Ner.Token tt2 = dcht.BeginToken.Previous; tt2 != null; tt2 = tt2.Previous) 
                    {
                        ...
                        if (prev != null) 
                        {
                            ...
                            if (prevPart != null && ((prevPart.NameAsItem != null || prevPart.Preamble != null))) 
                            {
                                prevPart = null;
                                continue;
                            }
            ...
            for (Pullenti.Ner.Token t = kit.FirstToken; t != null; t = t.Next) 
            {
                ...
                while (tt != null) 
                {
                    ...
                    Pullenti.Ner.Decree.Internal.DecreeChangeToken dcr = Pullenti.Ner.Decree.Internal.DecreeChangeToken.TryAttach(tt, null, false, null, false, false, null);
                    if (dcr != null) 
                    {
        ...
        internal static Pullenti.Ner.Token CanBeStartOfAttachApproved(Pullenti.Ner.Token t)
        {
            ...
            if (tt != null) 
            {
                if (t.IsValue("НАСТОЯЩИЙ", null)) 
                    return null;
                if (t.IsValue("ПЕРЕЧЕНЬ", null) && t.IsNewlineBefore) 
                    return null;
            ...
            else 
            {
                ...
                for (Pullenti.Ner.Token tt2 = t.Previous; tt2 != null && cou2 > 0; tt2 = tt2.Previous,cou2--) 
                {
                    ...
                    if (tt2.IsNewlineBefore) 
                        break;
                    if ((tt2 is Pullenti.Ner.NumberToken) || tt2.LengthChar == 1) 
                        cou2++;
        ...
        internal static Pullenti.Ner.ReferentToken TryAttachApproved(Pullenti.Ner.Token t, Pullenti.Ner.Core.AnalyzerData ad, Pullenti.Ner.Core.TerminCollection aliases = null, Pullenti.Ner.Core.TerminCollection attachednames = null)
        {
            if (t == null) 
                return null;
            ...
            {
                if (atok != null && tt.EndChar <= atok.EndChar) 
                    continue;
                if ((++cou) > 100) 
                    break;
                lastTok = tt;
                if ((tt.IsCommaAnd || tt.IsCharOf(";.") || Pullenti.Ner.Core.BracketHelper.CanBeEndOfSequence(tt, false, null, false)) || tt.IsHiphen) 
                {
                ...
                if (tt.IsValue2("ЯВЛЯЮЩИЙСЯ", "ПРИЛОЖЕНИЕМ") || tt.IsValue2("ПРЕДУСМОТРЕННЫЙ", "ПРИЛОЖЕНИЕМ")) 
                {
                    keywordAfter = true;
                ...
                if (tt.IsNewlineBefore) 
                {
                    ...
                    if (tt.Previous != null && tt.Previous.IsCharOf(";.")) 
                        break;
                    if (tt.IsValue("ИСТОЧНИК", null) || tt.IsValue("ГАРАНТ", null) || tt.IsValue("КОНСУЛЬТАНТПЛЮС", null)) 
                        break;
                    if (tt.IsChar('(')) 
                    {
                    }
                ...
                if (tt.IsChar('(') && tt.Next != null) 
                {
                    ...
                    if (mt != null) 
                    {
                        ...
                        {
                            Pullenti.Ner.ReferentToken next = TryAttachApproved(tt.Next.Next, ad, aliases, null);
                            if (next != null) 
                            {
                                ...
                                if (nam == null || (nam.Length < 20) || nam.Length > 1000) 
                                    return null;
                                if (nam.StartsWith("ПРАВИЛО ", StringComparison.OrdinalIgnoreCase)) 
                                    nam = "Правила" + nam.Substring(7);
                                else if (nam.StartsWith("ОСНОВА ", StringComparison.OrdinalIgnoreCase)) 
                                    nam = "Основы" + nam.Substring(6);
                ...
                if (tok2 != null && tt.Chars.IsCapitalUpper) 
                {
                ...
                if (r != null && r.TypeName == "ORGANIZATION" && tt == t.Next) 
                    hasOrg = true;
                Pullenti.Ner.ReferentToken rt0 = _tryAttachApproved(tt, ad, true, false, aliases);
                if (rt0 == null && appNum != null) 
                {
                    rt0 = new Pullenti.Ner.ReferentToken(null, tt, tt);
                    DecreeReferent own = tt.GetReferent() as DecreeReferent;
                    if (own.Owner != null) 
                        own = own.Owner;
                ...
                if (rt0 != null) 
                {
                    if (tt.IsChar('(') && tt.Next.IsValue("ВВЕСТИ", null)) 
                        return null;
                    Pullenti.Ner.Token t1 = (appBefore == null ? tt.Previous : appBefore.Previous);
                    if (aliasT0 != null) 
                        t1 = aliasT0.Previous;
                ...
                if (tt.IsNewlineBefore && tt.Previous != null && tt.Previous.IsChar('.')) 
                    break;
                bool noVerb = false;
                if ((tt is Pullenti.Ner.TextToken) && !hasWich) 
                {
                    if ((tt as Pullenti.Ner.TextToken).IsPureVerb) 
                    {
                        ...
                        if (tt.Previous.IsValue("КОТОРЫЙ", null)) 
                            ...
                            noVerb = true;
                        else if ((tt as Pullenti.Ner.TextToken).Term.EndsWith("СЯ")) 
                            noVerb = true;
                        else 
                            break;
                    }
                ...
                if ((mc.IsVerb && !mc.IsAdjective && !mc.IsPreposition) && !noVerb) 
                {
                    if (tt.IsValue("ВНОСИТЬСЯ", null)) 
                    {
                    }
                    else 
                        hasVerb = true;
            ...
            if (((tt != null || ((lastTok != null && (cou < 30))))) && keyTok != null && ((!t.Chars.IsAllLower || ((t.Previous != null && t.Previous.IsValue("В", null)))))) 
            {
                ...
                if (t.Previous == null || t.BeginChar >= tt.Previous.BeginChar) 
                    return null;
                if (t.IsNewlineBefore && tt.IsNewlineBefore) 
                    return null;
                string typ = keyTok.GetNormalCaseText(Pullenti.Morph.MorphClass.Noun, Pullenti.Morph.MorphNumber.Undefined, Pullenti.Morph.MorphGender.Undefined, false);
                if (typ == "ПРАВИЛО") 
                    typ = "ПРАВИЛА";
                else if (typ == "ОСНОВА") 
                    typ = "ОСНОВЫ";
                    ...
                    if (nam == null) 
                    {
                        ...
                        if (nam != null) 
                        {
                            if (nam.StartsWith("ПРАВИЛО")) 
                                nam2 = "ПРАВИЛА" + nam.Substring(7);
                            if (nam.StartsWith("ОСНОВА")) 
                                nam2 = "ОСНОВЫ" + nam.Substring(6);
                        }
                    }
        ...
        public override void Process(Pullenti.Ner.Core.AnalysisKit kit)
        {
            ...
            for (Pullenti.Ner.Token t = kit.FirstToken; t != null; t = t.Next,lastDecDist++) 
            {
                ...
                Pullenti.Ner.ReferentToken rt = TryAttachApproved(t, ad, aliases, attachednames);
                if (t.IsValue("ПРАВИЛА", null)) 
                {
                }
                if (rt != null) 
                {
                    ...
                    {
                        attachednames.Add(new Pullenti.Ner.Core.Termin(nam));
                    }
                }
                if (t.GetReferent() is DecreeReferent) 
                {
                ...
                if (rt != null) 
                {
                    ...
                    if (mt != null) 
                    {
                        ...
                        {
                            if (rt.Referent != (mt.Tag as DecreeReferent)) 
        ...
        {
            Pullenti.Ner.ReferentToken rt = TryAttachApproved(begin, null, null, null);
            if (rt != null) 
                return rt;
        ...
        internal static List<Pullenti.Ner.MetaToken> TryAttachParts(List<Pullenti.Ner.Decree.Internal.PartToken> parts, Pullenti.Ner.Decree.Internal.DecreeToken baseTyp, Pullenti.Ner.Referent _defOwner, bool inChanges = false)
        {
            ...
            {
                if (parts[i].Typ == Pullenti.Ner.Decree.Internal.PartToken.ItemType.Sentence) 
                {
                    parts.Add(parts[i]);
                    parts.RemoveAt(i);
                    break;
            ...
            for (i = 0; i < parts.Count; i++) 
            {
                ...
                {
                    if (((parts[j].Values.Count == 0 && parts[j].Typ != Pullenti.Ner.Decree.Internal.PartToken.ItemType.Preamble && parts[j].Typ != Pullenti.Ner.Decree.Internal.PartToken.ItemType.Notice) && parts[j].Typ != Pullenti.Ner.Decree.Internal.PartToken.ItemType.Table && parts[j].Typ != Pullenti.Ner.Decree.Internal.PartToken.ItemType.Footnote) && parts[j].Typ != Pullenti.Ner.Decree.Internal.PartToken.ItemType.Form) 
                        break;
                ...
                for (j = i + 1; j < parts.Count; j++) 
                {
                    if (((parts[j].Values.Count == 0 && parts[j].Name == null && parts[j].Typ != Pullenti.Ner.Decree.Internal.PartToken.ItemType.Preamble) && parts[j].Typ != Pullenti.Ner.Decree.Internal.PartToken.ItemType.Notice && parts[j].Typ != Pullenti.Ner.Decree.Internal.PartToken.ItemType.Footnote) && parts[j].Typ != Pullenti.Ner.Decree.Internal.PartToken.ItemType.Table && parts[j].Typ != Pullenti.Ner.Decree.Internal.PartToken.ItemType.Form) 
                        break;
                    ...
                    else if ((!typs.Contains(parts[j].Typ) && j == (parts.Count - 1) && parts[0].CanBeNextNarrow(parts[j])) && j == 2) 
                    {
                        desc.Insert(0, parts[j]);
                        typs.Add(parts[j].Typ);
                        break;
            ...
            if (res.Count == 1 && parts.Count == 1 && parts[0].AddNames != null) 
            {
                ...
                foreach (Pullenti.Ner.MetaToken br in parts[0].AddNames) 
                {
                    ...
                    dp.AddSlot(DecreePartReferent.ATTR_NAME, null, true, 0);
                    dp.AddName(Pullenti.Ner.Core.MiscHelper.GetTextValueOfMetaToken(br, Pullenti.Ner.Core.GetTextAttr.No));
        ...
        class ThisDecree : Pullenti.Ner.MetaToken
        {
            ...
            public static ThisDecree TryAttach(Pullenti.Ner.Decree.Internal.PartToken dtok, Pullenti.Ner.Decree.Internal.DecreeToken baseTyp)
            {
                ...
                if (!tt.IsNewlineAfter && !res.HasThisRef) 
                {
                    ...
                    {
                        if (dt.Typ != Pullenti.Ner.Decree.Internal.DecreeToken.ItemType.Name) 
                            return null;
                    }
                }
                if (baseTyp != null && baseTyp.Value == res.Typ) 
