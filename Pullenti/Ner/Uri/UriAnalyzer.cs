    ...
    public class UriAnalyzer : Pullenti.Ner.Analyzer
    {
        ...
        public override Dictionary<string, byte[]> Images
        {
            get
            {
                ...
                res.Add(Pullenti.Ner.Uri.Internal.MetaUri.MailImageId, Pullenti.Ner.Core.Internal.ResourceHelper2.GetBytes("email.png"));
                res.Add(Pullenti.Ner.Uri.Internal.MetaUri.UriImageId, Pullenti.Ner.Core.Internal.ResourceHelper2.GetBytes("uri.png"));
                return res;
            }
        }
                            ...
                            for (Pullenti.Ner.Token ttt = t0; ttt != null; ttt = ttt.Previous) 
                            {
                                ...
                                if (ttt.IsValue("ПОЧТА", null) || ttt.IsValue("АДРЕС", null)) 
                                {
                                    ...
                                    if (ttt != null && ttt.IsChar('.')) 
                                        ttt = ttt.Previous;
                                    if (ttt != null && ((ttt.IsValue("ЭЛ", null) || ttt.IsValue("ЭЛЕКТРОННЫЙ", null)))) 
                                        b = ttt;
        ...
        public static void Initialize()
        {
            ...
            try 
            {
                ...
                string obj = Pullenti.Ner.Core.Internal.ResourceHelper2.GetString("UriSchemes.csv");
                if (obj == null) 
