...
namespace Pullenti.Ner
{
    ...
    public class AnalysisResult
    {
        ...
        /// <summary>
        /// Количество токенов исходного текста (до объединения в сущности)
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            res.AppendFormat("Общая длина {0} знаков ({1} токенов)", Sofa.Text.Length, TokensCount);
        ...
        /// </summary>
        /// <param name="pos">между BeginChar и EndChar</param>
        /// <param name="tFrom">с какого токена начинать поиск (null - FirstToken)</param>
        /// <return>токен или null</return>
        public Token FindTokenByPos(int pos, Token tFrom = null)
        {
            Token t = tFrom ?? FirstToken;
            for (; t != null; t = t.Next) 
            {
