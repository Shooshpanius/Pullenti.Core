    ...
    public class StreetItemToken : Pullenti.Ner.MetaToken
    {
        ...
        public bool IsRoad
        {
            get
            {
                if (Termin == null) 
                    return false;
                if (((Termin.CanonicText == "АВТОДОРОГА" || Termin.CanonicText == "ШОССЕ" || Termin.CanonicText == "ТРАКТ") || Termin.CanonicText == "АВТОШЛЯХ" || Termin.CanonicText == "ШОСЕ") || Termin.CanonicText == "МАГИСТРАЛЬ" || Termin.CanonicText == "МАГІСТРАЛЬ") 
                    return true;
                return false;
            }
        }
        ...
        internal AddressItemToken Area;
        ...
        internal static void PrepareAllData(Pullenti.Ner.Token t0)
        {
            ...
            for (Pullenti.Ner.Token t = t0; t != null; t = t.Next) 
            {
                ...
                if (str != null) 
                {
                    ...
                    if (str.Misc != null && str.BeginToken != str.EndToken) 
                    {
                        for (Pullenti.Ner.Token tt = str.BeginToken; tt != null && tt.EndChar <= str.EndChar; tt = tt.Next) 
                        {
                            Pullenti.Ner.Geo.Internal.GeoTokenData dd = tt.Tag as Pullenti.Ner.Geo.Internal.GeoTokenData;
        ...
        public static StreetItemToken TryParse(Pullenti.Ner.Token t, StreetItemToken prev = null, bool inSearch = false, Pullenti.Ner.Geo.Internal.GeoAnalyzerData ad = null)
        {
            ...
            if ((SpeedRegime && ((ad.SRegime || ad.AllRegime)) && !inSearch) && !(t is Pullenti.Ner.ReferentToken)) 
            {
                ...
                else 
                {
                    ...
                    if (d.Street != null) 
                    {
                        if (d.Street.Cond == null || d.NoCity) 
                            return d.Street;
            ...
            if (res != null && res.Typ != StreetItemType.Noun) 
            {
                ...
                else if (tt != null && tt.IsChar('(')) 
                {
                    ...
                    else 
                    {
                        ...
                        {
                            Pullenti.Ner.Geo.Internal.OrgTypToken oty = Pullenti.Ner.Geo.Internal.OrgTypToken.TryParse(tt.Next, false, null);
                            if (oty != null && oty.EndToken == sit.EndToken) 
                ...
                if (res.BeginToken == res.EndToken && ((res.Typ == StreetItemType.Name || res.Typ == StreetItemType.StdName || res.Typ == StreetItemType.StdPartOfName))) 
                {
                    ...
                    if (end != null) 
                    {
                        Pullenti.Ner.Core.TerminToken tok = m_Ontology.TryParse(end, Pullenti.Ner.Core.TerminParseAttr.No);
                        if (tok != null) 
                        {
                            if (((StreetItemType)tok.Termin.Tag) == StreetItemType.Noun || ((StreetItemType)tok.Termin.Tag) == StreetItemType.StdPartOfName) 
                                end = null;
                        }
                    }
                    if (end != null) 
        ...
        public static StreetItemToken _tryParse(Pullenti.Ner.Token t, bool ignoreOnto, StreetItemToken prev, bool inSearch)
        {
            if (t == null) 
                return null;
                {
                    ...
                    if (res1 != null) 
                    {
                        if (res1[0].Typ == StreetItemType.Name || res1[0].Typ == StreetItemType.StdName) 
                            return res1[0];
                        if (res1.Count == 1 && res1[0].Typ == StreetItemType.Number && res1[0].NumberHasPrefix) 
                            return res1[0];
                    }
                }
            ...
            if ((t.IsValue("А", null) || t.IsValue("АД", null) || t.IsValue("АВТ", null)) || t.IsValue("АВТОДОР", null)) 
            {
                ...
                if (t.IsValue("А", null)) 
                {
                    ...
                    if (tt1 != null && tt1.IsCharOf("\\/")) 
                        tt1 = tt1.Next;
                    else if ((tt1 != null && !tt1.IsWhitespaceAfter && tt1.IsCharOf(",.")) && Pullenti.Ner.Geo.Internal.MiscLocationHelper.IsUserParamAddress(tt1)) 
                        tt1 = tt1.Next;
                ...
                if (tt1 != null) 
                {
                    if (t == tt1 && (t.LengthChar < 5) && !Pullenti.Ner.Geo.Internal.MiscLocationHelper.IsUserParamAddress(t)) 
                    {
                    }
                    else 
                    {
            ...
            if ((((t.IsValue("ФЕДЕРАЛЬНЫЙ", null) || t.IsValue("ГОСУДАРСТВЕННЫЙ", null) || t.IsValue("АВТОМОБИЛЬНЫЙ", null)) || t.IsValue("ФЕД", null) || t.IsValue("ФЕДЕРАЛ", null)) || t.IsValue("ГОС", null) || t.IsValue("АВТО", null)) || t.IsValue("АВТОМОБ", null)) 
            {
                ...
                if (tok2 != null && ((tok2.Termin.CanonicText == "АВТОДОРОГА" || tok2.Termin.CanonicText == "МАГИСТРАЛЬ"))) 
            ...
            if (t.IsValue("НОЛЬ", null) || t.IsValue("НУЛЬ", null)) 
            {
                if (t.Next is Pullenti.Ner.NumberToken) 
                    return new StreetItemToken(t, t.Next) { Typ = StreetItemType.Number, Value = "0" + (t.Next as Pullenti.Ner.NumberToken).Value };
            }
            if (t.IsNewlineBefore) 
            {
                if (t.IsValue("ТАБЛИЦА", null) || t.IsValue("РИСУНОК", null) || t.IsValue("ФОРМУЛА", null)) 
                    return null;
            }
            ...
            {
                if ((t is Pullenti.Ner.TextToken) && (t as Pullenti.Ner.TextToken).Term == "ГЕРОЕВ") 
                {
                }
                else 
                {
            ...
            if (t.IsValue("БОЙЦОВ", null)) 
            {
                if ((t.Next is Pullenti.Ner.NumberToken) && (t.Next.Next is Pullenti.Ner.TextToken) && t.Next.Next.Morph.Case.IsGenitive) 
                    return new StreetItemToken(t, t.Next) { Typ = StreetItemType.Number, Value = (t.Next as Pullenti.Ner.NumberToken).Value };
            }
            ...
            if ((((nt = t as Pullenti.Ner.NumberToken))) != null) 
            {
                ...
                if (nnn != null) 
                {
                    ...
                    if ((nnn.Value.IndexOf('-') > 0 && prev != null && prev.Typ == StreetItemType.Noun) && prev.Termin.CanonicText == "МИКРОРАЙОН") 
                    {
                        int jj = nnn.Value.IndexOf('-');
                        for (Pullenti.Ner.Token tt2 = nnn.BeginToken.Next; tt2 != null && (tt2.EndChar < nnn.EndChar); tt2 = tt2.Next) 
                        {
                            if (tt2.IsHiphen) 
                            {
                                t = (res.EndToken = tt2.Previous);
                                res.Value = res.Value.Substring(0, jj);
                                return res;
                            }
                        }
                    }
                ...
                if (nex != null) 
                {
                    if (nex.ExTyp == Pullenti.Ner.Core.NumberExType.Kilometer) 
                    {
                        ...
                        if (res.Value.StartsWith("0") && res.Value.Length > 1) 
                            res.Value = res.Value.Substring(1);
            ...
            if ((t is Pullenti.Ner.ReferentToken) && (t as Pullenti.Ner.ReferentToken).BeginToken == (t as Pullenti.Ner.ReferentToken).EndToken && !t.Chars.IsAllLower) 
            {
                if (prev != null && prev.Typ == StreetItemType.Noun) 
                {
                    ...
                    {
                        StreetItemToken res = new StreetItemToken(t, t) { Typ = StreetItemType.Name, Value = Pullenti.Ner.Core.MiscHelper.GetTextValueOfMetaToken(t as Pullenti.Ner.ReferentToken, Pullenti.Ner.Core.GetTextAttr.No) };
                        if ((t.Next != null && t.Next.IsHiphen && (t.Next.Next is Pullenti.Ner.TextToken)) && !t.IsWhitespaceAfter && !t.Next.IsWhitespaceAfter) 
                        {
                            res.EndToken = t.Next.Next;
                            res.Value = string.Format("{0} {1}", res.Value, (res.EndToken as Pullenti.Ner.TextToken).Term);
                        }
                        return res;
                    }
                }
            ...
            {
                if (prev != null && ((prev.Typ == StreetItemType.Noun || prev.Typ == StreetItemType.StdAdjective))) 
                {
                }
                else 
                    return null;
            ...
            if (tt != null && tt.Morph.Class.IsAdjective) 
            {
                if (tt.Chars.IsCapitalUpper || Pullenti.Ner.Geo.Internal.MiscLocationHelper.IsUserParamAddress(tt) || ((prev != null && prev.Typ == StreetItemType.Number && tt.IsValue("ТРАНСПОРТНЫЙ", null)))) 
                {
                    ...
                    if (npt != null && npt.Adjectives.Count == 1) 
                        tte = npt.EndToken;
                    if (m_MiscNouns.TryParse(tte, Pullenti.Ner.Core.TerminParseAttr.No) != null) 
                    {
                    ...
                    if (npt != null && npt.BeginToken != npt.EndToken && npt.Adjectives.Count <= 1) 
                    {
                        ...
                        if (oo != null) 
                        {
                            if (((StreetItemType)oo.Termin.Tag) == StreetItemType.Noun || ((StreetItemType)oo.Termin.Tag) == StreetItemType.StdPartOfName) 
                                npt = null;
                        }
                    }
                    ...
                    if (npt != null && npt.BeginToken != npt.EndToken && npt.Adjectives.Count <= 1) 
                    {
                        ...
                        if (ok) 
                        {
                            ...
                            sit.AltValue = npt.GetNormalCaseText(null, Pullenti.Morph.MorphNumber.Undefined, Pullenti.Morph.MorphGender.Undefined, false);
                            if (sit.AltValue.EndsWith("ПОЛОК")) 
                                sit.AltValue = sit.AltValue.Substring(0, sit.AltValue.Length - 5) + "ПОЛК";
                            return sit;
                        }
                    }
                }
            }
            if (tt != null && (tt.Next is Pullenti.Ner.TextToken) && ((!tt.Next.Chars.IsAllLower || Pullenti.Ner.Geo.Internal.MiscLocationHelper.IsUserParamAddress(tt)))) 
            {
                if (m_MiscNouns.TryParse(tt, Pullenti.Ner.Core.TerminParseAttr.No) != null) 
                {
            ...
            if (tok != null && tok.BeginToken == tok.EndToken) 
            {
                if ((((StreetItemType)tok.Termin.Tag) == StreetItemType.Name || t.IsValue("ГАРАЖНО", null) || t.LengthChar == 1) || t.IsValue("СТ", null)) 
                {
                    ...
                    tok = null;
                else if (t.IsValue("АК", null) && t.Next != null && t.Next.IsHiphen) 
                    tok = null;
            ...
            if (tok != null && !ignoreOnto) 
            {
                ...
                if (((StreetItemType)tok.Termin.Tag) == StreetItemType.Absent) 
                    return new StreetItemToken(t, tok.EndToken) { Typ = StreetItemType.Absent };
                if (tt == null) 
                    return null;
                bool abr = true;
                switch ((StreetItemType)tok.Termin.Tag)
                {
                    ...
                    case StreetItemType.Noun:
                        ...
                        else if (!tt.Chars.IsAllLower && tt.LengthChar == 1 && !tt.IsValue("Ш", null)) 
                            break;
                        else if (tt.LengthChar == 1) 
                        {
                            ...
                            if (Pullenti.Ner.Geo.Internal.NameToken.CheckInitial(tt) != null) 
                                break;
                            if (tok.EndToken.IsChar('.')) 
                            {
                            }
                            ...
                            else if (tok.BeginToken == tok.EndToken && tt.IsValue("Ш", null) && ((tt.Chars.IsAllLower || Pullenti.Ner.Geo.Internal.MiscLocationHelper.IsUserParamAddress(tt)))) 
                            {
                        ...
                        if ((tok.EndToken == tok.BeginToken && !t.Chars.IsAllLower && t.Morph.Class.IsProperSurname) && t.Chars.IsCyrillicLetter) 
                        {
                            ...
                            {
                                if (!t.IsValue("НАБЕРЕЖНЫЙ", null)) 
                                    return null;
                            }
                        }
                        if (tt.Term == "ДОРОГОЙ" || tt.Term == "РЯДОМ") 
                            return null;
                        if (tt.IsValue("ЗАЕЗД", null) || tt.IsValue("ВЫЕЗД", null)) 
                        {
                            if (!Pullenti.Ner.Geo.Internal.MiscLocationHelper.IsUserParamAddress(tt)) 
                                return null;
                        }
                        if (tt.IsValue("НАБЕРЕЖНЫЙ", null) && (tt is Pullenti.Ner.TextToken)) 
                        {
                            bool isName = false;
                            StreetItemToken next = _tryParse(tt.Next, ignoreOnto, null, inSearch);
                            if (prev != null) 
                            {
                                if (next != null && next.Typ == StreetItemType.Name) 
                                {
                                }
                                else if (prev.Typ == StreetItemType.Noun || prev.Typ == StreetItemType.Number) 
                                    isName = true;
                            }
                            else if (next == null) 
                                isName = true;
                            else if (next.Typ == StreetItemType.Noun || next.Typ == StreetItemType.Number) 
                                isName = true;
                            if (isName) 
                        ...
                        if ((!abr && tok.BeginToken == tok.EndToken && !tok.BeginToken.Chars.IsAllLower) && ((mc.IsNoun || mc.IsAdjective))) 
                        {
                        ...
                        if (!res.IsWhitespaceAfter && res.EndToken.Next.IsChar('(')) 
                        {
                            ...
                            if (br != null && (br.LengthChar < 5) && (br.BeginToken.Next is Pullenti.Ner.TextToken)) 
                    ...
                    case StreetItemType.StdName:
                        ...
                        if (((t.LengthChar == 1 && t.Next != null && t.Next.IsChar('.')) && t.Next.Next != null && t.Next.Next.LengthChar == 1) && t.Next.Next.EndChar <= tok.EndChar) 
                        {
                        ...
                        if ((sits.EndToken.Next is Pullenti.Ner.TextToken) && sits.EndToken.Next.LengthChar == 1) 
                        {
                            if (Pullenti.Ner.Geo.Internal.NameToken.CheckInitialAndSurname((sits.EndToken.Next as Pullenti.Ner.TextToken).Term, sits.BeginToken)) 
                            {
                                sits.EndToken = sits.EndToken.Next;
                                if (sits.EndToken.Next != null && sits.EndToken.Next.IsChar('.')) 
                                    sits.EndToken = sits.EndToken.Next;
                            }
                        }
                        return sits;
                    case StreetItemType.StdPartOfName:
                        ...
                        if (tt1.Next != null) 
                        {
                            if ((tt1.Next.IsValue("ПОЛИЦИИ", null) || tt1.Next.IsValue("МИЛИЦИИ", null) || tt1.Next.IsValue("ГВАРДИИ", null)) || tt1.Next.IsValue("АРМИИ", null)) 
                                tt1 = tt1.Next;
                            if (tt1.Next != null && (tt1.Next.GetReferent() is Pullenti.Ner.Geo.GeoReferent)) 
                                tt1 = tt1.Next;
                            else 
                            {
                                Pullenti.Ner.Geo.Internal.TerrItemToken ter = Pullenti.Ner.Geo.Internal.TerrItemToken.TryParse(tt1.Next, null, null);
                        ...
                        if ((sit == null && tt1.Next != null && vvv != null) && tt1.Next.IsHiphen) 
                            sit = TryParse(tt1.Next.Next, null, false, null);
                        ...
                        {
                            if (((tok.Morph.Number & Pullenti.Morph.MorphNumber.Plural)) == Pullenti.Morph.MorphNumber.Plural) 
                        ...
                        else if (sit.ExistStreet == null) 
                        {
                            if (vvv == "ГЕРОЯ") 
                            {
                                if ((tt1 as Pullenti.Ner.TextToken).Term != "ГЕРОЕВ" && sit.BeginToken.Morph.Class.IsProperSurname) 
            ...
            if (tt != null) 
            {
                ...
                if ((tt.Next != null && ((tt.Next.IsChar('.') || ((tt.Next.IsHiphen && tt.LengthChar == 1)))) && ((!tt.Chars.IsAllLower || Pullenti.Ner.Geo.Internal.MiscLocationHelper.IsUserParamAddress(tt)))) && (tt.Next.WhitespacesAfterCount < 3) && (tt.Next.Next is Pullenti.Ner.TextToken)) 
                {
                    ...
                    if (tt.LengthChar == 1 && tt1.LengthChar == 1 && (tt1.Next is Pullenti.Ner.TextToken)) 
                    {
                        if (tt1.IsAnd && tt1.Next.Chars.IsAllUpper && tt1.Next.LengthChar == 1) 
                            tt1 = tt1.Next;
                        if ((tt1.Chars.IsAllUpper && tt1.Next != null && tt1.Next.IsChar('.')) && (tt1.Next.WhitespacesAfterCount < 3) && (tt1.Next.Next is Pullenti.Ner.TextToken)) 
                            tt1 = tt1.Next.Next;
                    ...
                    if (sit != null) 
                    {
                        ...
                        if (ait != null) 
                        {
                            if (!string.IsNullOrEmpty(ait.Value) && ait.Value != "0" && char.IsDigit(ait.Value[0])) 
                                sit = null;
                        }
                    }
                ...
                if (tt.Chars.IsCyrillicLetter && tt.LengthChar > 1 && !tt.Morph.Class.IsPreposition) 
                {
                    ...
                    if (!tt.Chars.IsAllLower) 
                    {
                        ...
                        if (ait != null) 
                        {
                            ...
                            else if (ait.Typ == AddressItemType.Space && ait.DetailParam != null) 
                                ok1 = true;
                            else if ((ait.Typ != AddressItemType.Number && ait.Typ != AddressItemType.Potch && ait.Typ != AddressItemType.NoNumber) && ait.BeginToken == ait.EndToken && !ait.Chars.IsAllLower) 
                                ok1 = true;
                        }
                        else 
                            ok1 = true;
                    ...
                    else if (tt.WhitespacesAfterCount < 2) 
                    {
                        ...
                        {
                            AddressItemToken aaa = AddressItemToken.TryParsePureItem(tt, null, null);
                            if (aaa == null) 
                                ok1 = true;
                            else if (tt.IsValue("УГОЛ", null)) 
                                ok1 = true;
                        }
                    }
                    ...
                    if (ok1) 
                    {
                        ...
                        if ((tt.Next != null && (tt.Next.IsHiphen) && (tt.Next.Next is Pullenti.Ner.TextToken)) && !tt.IsWhitespaceAfter && !tt.Next.IsWhitespaceAfter) 
                        {
                            ...
                            if (!ok2 && (tt.Next.Next.Next is Pullenti.Ner.NumberToken)) 
                                ok2 = true;
                            ...
                            if (ok2) 
                            {
                                ...
                                if (res.EndToken.Chars.IsLatinLetter) 
                                {
                                    Pullenti.Ner.NumberToken lat = Pullenti.Ner.Core.NumberHelper.TryParseRoman(res.EndToken);
                                    if (lat != null) 
                                    {
                                        res.Value = Pullenti.Ner.Core.MiscHelper.GetTextValue(tt, tt, Pullenti.Ner.Core.GetTextAttr.No);
                                        res.NextItem = new StreetItemToken(tt.Next.Next, lat.EndToken) { Typ = StreetItemType.Number, Value = lat.Value, NumberHasPrefix = true };
                                        res.EndToken = tt.Next;
                                        return res;
                                    }
                                }
                                if (tt.GetMorphClassInDictionary().IsProperName && !(tt as Pullenti.Ner.TextToken).Term.EndsWith("О") && res.EndToken.Morph.Class.IsProperSurname) 
                                {
                                    res.Misc = Pullenti.Ner.Core.MiscHelper.GetTextValue(tt, tt, Pullenti.Ner.Core.GetTextAttr.No);
                        ...
                        {
                            if (tt.Next.IsValue("БИ", null) || tt.Next.IsValue("АТА", null) || tt.Next.IsValue("СУ", null)) 
                            {
                                if (res.Value == null) 
                                    res.Value = Pullenti.Ner.Core.MiscHelper.GetTextValue(tt, tt, Pullenti.Ner.Core.GetTextAttr.No);
                                res.EndToken = tt.Next;
                            ...
                            else if (!AddressItemToken.CheckHouseAfter(tt.Next, false, false) || tt.Next.IsNewlineAfter) 
                            {
                                ...
                                if (nn == null || nn.Typ == StreetItemType.Name) 
                                {
                                    ...
                                    else if ((nn != null && t.LengthChar >= 3 && t.GetMorphClassInDictionary().IsProperName) && ((nn.BeginToken.Morph.Class.IsProperSurname || nn.EndToken.Morph.Class.IsProperSurname || nn.BeginToken.Morph.Class.IsProperSecname))) 
                                    {
                                        res.EndToken = nn.EndToken;
                                        if (nn.BeginToken.Next == nn.EndToken && nn.BeginToken.Morph.Class.IsProperSecname) 
                                            res.Value = Pullenti.Ner.Core.MiscHelper.GetTextValue(nn.BeginToken.Next, nn.EndToken, Pullenti.Ner.Core.GetTextAttr.No);
                                        else if (nn.OrtoTerr != null) 
                                        {
                                            res.Value = Pullenti.Ner.Core.MiscHelper.GetTextValue(nn.BeginToken, nn.BeginToken, Pullenti.Ner.Core.GetTextAttr.No);
                                            res.OrtoTerr = nn.OrtoTerr;
                                        }
                                        else 
                                        ...
                                        if (nn.BeginToken.Morph.Class.IsProperSecname && nn.EndToken.Next != null && nn.EndToken.Next.Morph.Class.IsProperSurname) 
                                        {
                                            res.EndToken = nn.EndToken.Next;
                                            res.Value = Pullenti.Ner.Core.MiscHelper.GetTextValue(res.EndToken, res.EndToken, Pullenti.Ner.Core.GetTextAttr.No);
                                        }
                                    }
                                    else if ((tt1 != null && tt1.LengthChar > 2 && AddressItemToken.CheckHouseAfter(tt1.Next, false, false)) && tt1.Chars.IsCyrillicLetter == tt.Chars.IsCyrillicLetter && (t.WhitespacesAfterCount < 2)) 
                                    {
                                        if (tt1.Morph.Class.IsVerb && !tt1.IsValue("ДАЛИ", null)) 
                                        {
                                        }
                                        else if (npt == null && ((!tt1.Chars.IsAllLower || Pullenti.Ner.Geo.Internal.MiscLocationHelper.IsUserParamAddress(tt1))) && !isPref) 
                                        {
                                        }
                                        else 
                                        {
                                    ...
                                    else if (nn != null && nn.BeginToken.Next == nn.EndToken && nn.EndToken.Morph.Class.IsProperSurname) 
                                    {
                                        res.EndToken = nn.EndToken;
                                        if (nn.Misc != null && nn.EndToken.Morph.Class.IsProperSecname) 
                                        {
                                            res.Value = Pullenti.Ner.Core.MiscHelper.GetTextValue(t, t, Pullenti.Ner.Core.GetTextAttr.No);
                                            res.Misc = nn.Misc;
                                        }
                                        else 
                                        {
                                            res.Value = Pullenti.Ner.Core.MiscHelper.GetTextValue(nn.EndToken, nn.EndToken, Pullenti.Ner.Core.GetTextAttr.No);
                                            res.Misc = Pullenti.Ner.Core.MiscHelper.GetTextValue(t, t, Pullenti.Ner.Core.GetTextAttr.No);
                                        }
                                    }
                                }
                        ...
                        if (res != null && res.Typ == StreetItemType.Name && (res.WhitespacesAfterCount < 2)) 
                        {
                            ...
                            if (Pullenti.Ner.Geo.Internal.MiscLocationHelper.IsUserParamAddress(tt) && tt.IsChar('.')) 
                            ...
                            else if ((tt != null && tt.LengthChar == 1 && tt.Next != null) && ((tt.Chars.IsAllUpper || ((Pullenti.Ner.Geo.Internal.MiscLocationHelper.IsUserParamAddress(tt) && tt.Next.IsChar('.'))))) && tt.Next.IsCharOf(".,")) 
                            {
                                if (TryParse(tt, null, false, null) != null || ((!tt.Next.IsComma && AddressItemToken.CheckHouseAfter(tt, false, false)))) 
                                {
                                }
                                else if (AddressItemToken.CheckHouseAfter(tt.Next.Next, false, false)) 
                                {
                                    if (tt.IsValue("Ш", null)) 
                                    {
                                    }
                                    else 
                                    {
                                ...
                                else 
                                {
                                    ...
                                    if (rt == null) 
                                    {
                                        ...
                                        res.EndToken = tt.Next;
                                        tt = res.EndToken.Next as Pullenti.Ner.TextToken;
                                        if (((res.WhitespacesAfterCount < 2) && tt != null && tt.LengthChar == 1) && ((tt.Chars.IsAllUpper || Pullenti.Ner.Geo.Internal.MiscLocationHelper.IsUserParamAddress(tt)))) 
                                        {
                                ...
                                if (rt != null) 
                                {
                                    ...
                                    if (ok2) 
                                    {
                                        ...
                                        if (res.BeginToken != res.EndToken) 
                                        {
                                            ...
                                            else if (mc1.IsProperName && ((mc2.IsProperSurname || mc2.IsProperName || mc2.IsUndefined))) 
                                            {
                                                res.Misc = res.Value;
                                                res.Value = Pullenti.Ner.Core.MiscHelper.GetTextValue(res.EndToken, res.EndToken, Pullenti.Ner.Core.GetTextAttr.No);
                                            }
                                            ...
                                            {
                                                Pullenti.Ner.ReferentToken pp = res.Kit.ProcessReferent("PERSONPROPERTY", res.BeginToken, null);
                                                if (pp != null && pp.EndToken == res.EndToken.Previous && !mc1.IsProperSurname) 
                                                {
                                                    res.Misc = res.Value;
                                                    res.Value = Pullenti.Ner.Core.MiscHelper.GetTextValue(res.EndToken, res.EndToken, Pullenti.Ner.Core.GetTextAttr.No);
                                                }
                                                else if ((res.BeginToken.Morph.Class.IsProperSurname && res.BeginToken.Next.Morph.Class.IsProperName && res.BeginToken.Next.Next == res.EndToken) && res.EndToken.Morph.Class.IsProperSecname) 
                                                    res.Misc = Pullenti.Ner.Core.MiscHelper.GetTextValue(res.EndToken.Previous, res.EndToken.Previous, Pullenti.Ner.Core.GetTextAttr.No);
                                                else 
                        ...
                        if (res.BeginToken == res.EndToken) 
                        {
                            ...
                            else if (res.Typ == StreetItemType.Name) 
                            {
                                int cou = 0;
                                for (Pullenti.Ner.Token ttt = res.EndToken.Next; ttt != null && (cou < 2); ttt = ttt.Next,cou++) 
                                {
                                    if (!ttt.IsHiphen) 
                                        break;
                                    if (ttt.IsWhitespaceBefore || ttt.IsWhitespaceAfter) 
                                        break;
                                    if (!(ttt.Next is Pullenti.Ner.TextToken) || (ttt.Next.LengthChar < 2) || ttt.Next.Chars.IsLatinLetter) 
                                        break;
                                    if (m_Ontology.TryParse(ttt.Next, Pullenti.Ner.Core.TerminParseAttr.No) != null) 
                                        break;
                                    ttt = ttt.Next;
                                    if (res.Value == null) 
                                        res.Value = Pullenti.Ner.Core.MiscHelper.GetTextValueOfMetaToken(res, Pullenti.Ner.Core.GetTextAttr.No);
                                    res.Value = string.Format("{0} {1}", res.Value, (ttt as Pullenti.Ner.TextToken).Term);
                                    if (res.AltValue != null) 
                                        res.AltValue = string.Format("{0} {1}", res.AltValue, (ttt as Pullenti.Ner.TextToken).Term);
                                    res.EndToken = ttt;
                                }
                            }
                        }
                ...
                if (((tt is Pullenti.Ner.TextToken) && tt.LengthChar == 1 && (tt.WhitespacesBeforeCount < 2)) && tt.Chars.IsLetter && tt.Chars.IsAllUpper) 
                {
                    if (prev != null && prev.Typ == StreetItemType.Noun) 
                    {
                        Pullenti.Ner.Geo.Internal.NumToken nn = Pullenti.Ner.Geo.Internal.NumToken.TryParse(tt, Pullenti.Ner.Geo.Internal.GeoTokenType.Strong);
                        if (nn != null) 
                        {
                            if (nn.EndToken != tt) 
                                return new StreetItemToken(tt, nn.EndToken) { Typ = StreetItemType.Number, Value = nn.Value };
            ...
            if (((prev != null && prev.Typ == StreetItemType.Name && prev.BeginToken == prev.EndToken) && (tt is Pullenti.Ner.TextToken) && tt.Chars.IsLatinLetter) && tt.Previous != null && tt.Previous.GetMorphClassInDictionary().IsProperName) 
            {
                Pullenti.Ner.NumberToken num = Pullenti.Ner.Core.NumberHelper.TryParseRoman(tt);
                if (num != null) 
                    return new StreetItemToken(tt, num.EndToken) { Typ = StreetItemType.Number, Value = num.Value };
            }
        ...
        internal static List<StreetItemToken> TryParseSpec(Pullenti.Ner.Token t, StreetItemToken prev)
        {
            ...
            List<StreetItemToken> res = null;
            StreetItemToken sit;
            if (t.IsValue2("ЗА", "ЛИНИЕЙ")) 
            {
                AddressItemToken next = AddressItemToken.TryParse(t.Next.Next, false, null, null);
                if (next != null) 
                {
                    sit = new StreetItemToken(t, next.EndToken) { Typ = StreetItemType.StdName };
                    string nnn = (next.Referent != null ? next.Referent.ToString().ToUpper() : next.ToString().ToUpper());
                    if (nnn.StartsWith("ТЕРРИТОРИЯ ")) 
                        nnn = nnn.Substring(11);
            ...
            if (t.GetReferent() is Pullenti.Ner.Date.DateReferent) 
            {
                ...
                {
                    if (dr.Month > 0 && (t as Pullenti.Ner.ReferentToken).BeginToken == (t as Pullenti.Ner.ReferentToken).EndToken) 
                    {
                        res = new List<StreetItemToken>();
                        res.Add((sit = new StreetItemToken(t, t) { Typ = StreetItemType.StdName, Value = Pullenti.Ner.Core.MiscHelper.GetTextValueOfMetaToken(t as Pullenti.Ner.ReferentToken, Pullenti.Ner.Core.GetTextAttr.No) }));
                        return res;
                    }
                    return null;
                }
            ...
            if (prev != null && prev.IsRoad && (t.WhitespacesBeforeCount < 3)) 
                canBeRoad = true;
            else if (((prev == null && t.Next != null && t.Next.IsHiphen) && Pullenti.Ner.Geo.Internal.MiscLocationHelper.IsUserParamAddress(t) && t.Next.Next != null) && t.Next.Next.LengthChar > 1) 
            {
                int cou = 5;
            ...
            if (canBeRoad) 
            {
                ...
                {
                    if (tt.WhitespacesBeforeCount > 3 && tt != t) 
                        break;
                    ...
                    if (tt.Next != null && tt.Next.IsHiphen) 
                        tt = tt.Next;
                    else if (tt.Next != null && tt.Next.IsComma && br) 
                        tt = tt.Next;
                    else 
                        break;
                }
            ...
            if ((t is Pullenti.Ner.TextToken) && t.LengthChar == 1 && t.Chars.IsLetter) 
            {
                ...
                if (tt2 != null && tt2.IsHiphen) 
                    tt2 = tt2.Next;
                if ((tt2 is Pullenti.Ner.NumberToken) && !tt2.IsWhitespaceBefore) 
                {
                    if (prev != null && prev.Typ == StreetItemType.Name) 
                    {
                        ...
                        {
                            res = new List<StreetItemToken>();
                            res.Add(new StreetItemToken(t, tt2) { Typ = StreetItemType.Number, NumberHasPrefix = true, Value = (tt2 as Pullenti.Ner.NumberToken).Value });
                            return res;
                        }
                    }
                }
