    ...
    public class MeasureAnalyzer : Pullenti.Ner.Analyzer
    {
        ...
        public override Dictionary<string, byte[]> Images
        {
            get
            {
                ...
                res.Add(Pullenti.Ner.Measure.Internal.MeasureMeta.ImageId, Pullenti.Ner.Core.Internal.ResourceHelper2.GetBytes("measure.png"));
                res.Add(Pullenti.Ner.Measure.Internal.UnitMeta.ImageId, Pullenti.Ner.Core.Internal.ResourceHelper2.GetBytes("munit.png"));
                return res;
            }
        }
